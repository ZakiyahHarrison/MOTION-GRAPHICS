...
function heroAnimation(){
    ...
    tl.from("#hero-text",{duration:1.25,x:-300, alpha: 0})
    .from("button",{duration:1.5,y:100, alpha: 0} ,"-0.25" )
    .from("h2",{duration:1.5,x:-300, alpha: 0} ,"-0.25" )
    });

    mm.add("(max-width: 767px)", () => {
    // mobile setup code here...
    tl.from("#hero-text",{duration:1.25,y:-300, alpha: 0})
    .from("button",{duration:1.5,y:100, alpha: 0} ,"-0.25" )
    .from("h2",{duration:1.5,y:-300, alpha: 0} ,"-0.25" )
    });
...
function vinesectionAnimation (){
    var tl= gsap.timeline({scrollTrigger:
        {trigger:"#vines", scrub: true, markers: false, end:"bottom 80%", start: "top 30%" }});
...
function section1Animation (){
   var tl = gsap.timeline({scrollTrigger:
    {trigger:"#section-1-content", scrub: true, markers: false, end:"top 40%", start: "top 70%" }}); 
...
function section2Animation (){
    var tl = gsap.timeline({scrollTrigger:
        {trigger:"#section2", scrub: true, markers: false, end:"top 10%", start: "top 60%" }}); 
...
function section3Animation (){
    var tl = gsap.timeline({scrollTrigger:
        {trigger:"#section-3-content", scrub: true, markers: true, end:"top 20%", start: "top 60%" }}); 
